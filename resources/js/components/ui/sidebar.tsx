...
function SidebarProvider({
  ...
  const readInitialCookieOpen = (): boolean | undefined => {
    if (typeof document === "undefined") return undefined

    // Basic cookie parse: `${name}=value; ...`
    ...
    // We write boolean (`true`/`false`) to the cookie.
  ...
  const cookieOpen = readInitialCookieOpen()
  const [_open, _setOpen] = React.useState(cookieOpen ?? defaultOpen)
