...
import { adminLogin, login, register, forgotPassword } from '@/routes';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="px-8 py-12 sm:px-12">
                            <div className="max-w-md">
                                ...
                                <div className="text-3xl font-semibold text-slate-900">Welcome back, Program Head</div>
                                <div className="mt-1 text-sm text-slate-600">Sign in to access your dashboard</div>
                                        ...
                                        <>
                                            <div className="space-y-5">
                                                ...
                                                <div className="text-center text-sm text-slate-600">
                                                    ...
                                                    {' '}or{' '}
                                                    <TextLink href={adminLogin()} className="text-blue-700" tabIndex={8}>
                                                        Admin
                                                    </TextLink>
                                                </div>
