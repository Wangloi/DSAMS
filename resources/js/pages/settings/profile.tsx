                    ...
                    <div className="min-w-0 flex-1 space-y-1">
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {roleLabel && (
                                <Badge
                                    variant="secondary"
                                    className="bg-[#23509A]/10 text-[#23509A] dark:bg-blue-500/15 dark:text-blue-300"
                                >
                                    {roleLabel}
                                </Badge>
                            )}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription className="mt-1 text-sm">
                                Update the name and email shown across DSAMS.
                            ...
                            <>
                                ...
                                <div className="flex flex-col gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:items-center sm:justify-between dark:border-slate-800">
                                    <p className="text-xs text-slate-500 dark:text-slate-400">
                                        ...
                                        browser. Your session stays active after
                                        saving.
                                    </p>
