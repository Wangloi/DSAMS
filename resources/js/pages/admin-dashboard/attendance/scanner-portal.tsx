...
export default function AdminAttendanceScannerPortalPage({
    event,
                    ...
                    <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-6 lg:grid-cols-3">
                                ...
                                <div className="flex flex-col items-center gap-6 px-6 py-10">
                                    {qrError ? (
                                        ...
                                        <>
                                            ...
                                            {/* Countdown label */}
                                            <div
                                                className={`flex items-center gap-2 text-sm font-semibold transition-colors ${remaining <= 5 ? 'text-red-500' : 'text-slate-500'}`}
                                            >
                                            ...
                                            <p className="max-w-sm text-center text-xs text-slate-500 dark:text-white/40">
                                                Show this QR code on your screen
                                                or projector. Students scan it
                                                using their DSAMS app to check
                                                in. It auto-rotates every{' '}
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="rounded-2xl border border-blue-100 bg-blue-50 p-5 dark:border-indigo-500/20 dark:bg-indigo-500/10">
                                <div className="mb-3 text-sm font-semibold text-blue-700 dark:text-indigo-300">
                                    How Students Scan
                                </div>
