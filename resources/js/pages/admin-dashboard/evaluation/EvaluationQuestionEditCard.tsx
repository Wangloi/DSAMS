...
export default function EvaluationQuestionEditCard({
    ...
    return (
        <div className="group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
            <div className="flex">
                <div className="w-1 bg-[#23509A] transition-colors group-hover:bg-[#1e4a8a]"></div>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div className="flex items-center space-x-2 pt-6">
                                <input
                                    ...
                                    className="h-4 w-4 rounded border-slate-300 text-[#23509A] focus:ring-[#23509A] dark:border-slate-600"
                                />
                                <Label
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="space-y-2">
                                    {(q.options ?? []).map((opt, i) => (
                                        ...
                                        >
                                            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-xs font-medium text-slate-700 dark:bg-slate-700 dark:text-slate-300">
                                            ...
                                            <Button
                                                ...
                                                className="h-8 w-8 p-0 text-slate-400 hover:text-red-600 dark:text-slate-400 dark:hover:text-red-400"
                                            >
                                                <svg
                                                    className="h-4 w-4"
                                                    fill="none"
