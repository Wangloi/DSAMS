...
export default function EvaluationPreviewDialog({
    open,
    onOpenChange,
    evaluation,
}: Props) {
            ...
            <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-3xl">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 text-base">
                        <span className="grid h-9 w-9 place-items-center rounded-full bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-300">
                    ...
                    <DialogDescription>
                        Read-only preview of the evaluation form.
                    </DialogDescription>
                </DialogHeader>
                                    ...
                                    return (
                                        <div key={q.id} className="space-y-3">
                                            {isNewSection && q.section && (
                                                <div className="rounded-lg border border-blue-200 bg-blue-50/70 p-3 dark:border-blue-900/40 dark:bg-blue-950/30">
