                            ...
                            <Card className="border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-[#0F213A]">
                                <CardContent className="p-6">
                                    ...
                                    <div className="space-y-2.5">
                                        {isMajor ? (
                                            <>
                                                <div className="dark:text-rose-350 flex items-center gap-3 rounded-xl border border-rose-100 bg-rose-50 p-3 text-xs font-bold text-rose-800 dark:border-rose-900/30 dark:bg-rose-950/20">
                                                ...
                                                {incident.raw
                                                    ?.immediateAction && (
                                                    <div className="dark:text-amber-350 flex items-center gap-3 rounded-xl border border-amber-100 bg-amber-50 p-3 text-xs font-bold text-amber-800 dark:border-amber-900/30 dark:bg-amber-950/20">
                                            ...
                                            <>
                                                <div className="dark:text-blue-350 flex items-center gap-3 rounded-xl border border-blue-100 bg-blue-50 p-3 text-xs font-bold text-blue-800 dark:border-blue-900/30 dark:bg-blue-950/20">
                                                    <ShieldAlert className="h-4 w-4 shrink-0" />
                                                    <span>
                                                        Written warning filed in
                                                        student record
                                                    </span>
                                                </div>
                                                {incident.raw
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex flex-wrap items-center justify-between gap-x-2 gap-y-1">
                                                        ...
                                                        <span className="text-[10px] font-bold tracking-tight text-slate-400 uppercase">
                                                            {
                                                                incident.dateTime.split(
                                                                    ' ',
                                                                )[0]
                                                            }
                                                        </span>
                                                    </div>
                                                    <p className="dark:text-slate-355 mt-1 text-[11px] leading-relaxed font-medium text-slate-600">
                                                        {incident.raw
                                                            .immediateAction ||
                                                            'No immediate action logged yet.'}
                                                    </p>
                                                    <div className="mt-2 flex items-center gap-2">
                                                        <Badge className="hover:bg-emerald-150 border-emerald-250 rounded border border-0 bg-emerald-100 px-1.5 py-0 text-[9px] font-black tracking-wide text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400">
                                                            LOGGED
                                                        </Badge>
                                ...
                                <CardContent className="p-6">
                                    ...
                                    <div className="relative space-y-6 border-l-2 border-slate-100 pl-6 dark:border-slate-800">
                                        ...
                                        <div className="relative">
                                            <span
                                                className={`absolute top-0.5 -left-[31px] flex h-4.5 w-4.5 items-center justify-center rounded-full ${
                                                    isMajor
