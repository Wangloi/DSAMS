            ...
            <div className="min-h-[calc(100vh-4rem)] bg-slate-100 dark:bg-slate-900">
                <div className="flex w-full flex-col gap-6 px-6 py-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Edit Program</h1>
                            <p className="text-slate-600 dark:text-slate-400">Update program information</p>
                        </div>
                    </div>
