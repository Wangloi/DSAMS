...
import { Home, Users, Calendar, FileText, Settings, LogOut, Award } from 'lucide-react';
...
export default function DSALayout({ children, breadcrumbs = [] }: DSALayoutProps) {
                ...
                <div className="hidden md:flex md:w-64 md:flex-col">
                    <div className="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-white border-r border-gray-200">
                        <div className="flex items-center flex-shrink-0 px-4">
                            <img className="h-8 w-auto" src="/images/SRCB.png" alt="SRCB" />
                            <span className="ml-2 text-xl font-semibold text-gray-900">DSA Portal</span>
                        </div>
                                            ...
                                            {breadcrumbs.map((breadcrumb, index) => (
                                                <li key={index} className="flex items-center">
                                                    ...
                                                    {breadcrumb.href ? (
                                                        ...
                                                        <span className="text-sm font-medium text-gray-900">{breadcrumb.title}</span>
                                                    )}
                                                </li>
                                            ))}
                                        </ol>
